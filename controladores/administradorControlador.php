<?php 
    ...
    class administradorControlador extends administradorModelo{
      ...
      $direccion=mainModel::limpiar_cadena($_POST['direccion-reg']);
    	...
    	$password2=mainModel::limpiar_cadena($_POST['pas$password2-reg']);
      ...
      if ($password1!=$password2) {
         $alerta=[
            ...
            "Texto"=>"Las contraseñas que acabas de ingresar no coiciden, por favor intente nuevamente",
            "Tipo"=>"error"
         ];
      } else {
         ...
         if ($consulta1->rowCount()>=1) {
            $alerta=[
               "Alerta"=>"simple",
               "Titulo"=>"Ocurrio un error inesperado",
               "Texto"=>"El DNI qe acaba de ingresar ya se encuentra registrado en el sistema",
               "Tipo"=>"error"
            ];
         } else {
            if ($email!="") {
            ...
            if ($ec>=1) {
               $alerta=[
                  "Alerta"=>"simple",
                  "Titulo"=>"Ocurrio un error inesperado",
                  "Texto"=>"El EMAIL que aca de ingresar ya se encuetra registrado en el sistema",
                  "Tipo"=>"error"
               ];
            } else {
               ...
               if ($consulta3->rowCount()=>1) {
                  $alerta=[
                     "Alerta"=>"simple",
                     "Titulo"=>"Ocurrio un error inesperado",
                     "Texto"=>"El USUARIO que aca de ingresar ya se encuetra registrado en el sistema",
                     "Tipo"=>"error"
                  ];
               } else {
